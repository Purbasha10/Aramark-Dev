...
create or replace view svm_predictions as
SELECT MASTER_ITEM_NAME_1 as Name, categorize_products(MASTER_ITEM_NAME_1, MAJOR_SOURCE_NAME, MINOR_SOURCE_NAME) as Predicted_Categories from SANDBOX_DB.SANDBOX_STAGE.UNMAPPED_PRODUCTS_REFINED;